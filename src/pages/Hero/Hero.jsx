...
impl DeveloperProfile {
    fn is_hireable(&self) -> bool {
        self.hard_worker && self.problem_solver && self.experience >= 7
    }
}
fn main() {
    ...
    println!(
        "Hireable: {}",
        if profile.is_hireable() { "Yes" } else { "No" }
    );
}
  `);
      ...
      <main className="bg-[#020617] text-white min-h-screen">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Blockchain Developer | Full-Stact Developer | 
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Large-Diamond"
              ...
              <div className="hidden lg:block absolute left-[5.5rem] top-[2.3rem] animate-float-slow">
                <div className="px-4 py-2 rounded-lg bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 text-purple-400">
                  <i className="fas fa-wand-magic-sparkles"></i>&nbsp;&nbsp;Perfect Smart Contract
                </div>
              </div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce flex flex-col items-center gap-2">
          <span className="text-gray-400 text-sm flex items-center gap-2">
            <i className="fas fa-mouse text-blue-400"><BsMouse2/></i>
            About me
          </span>
